<template>
    <section class="modal-background">
        ...
        <section class="modal-container">
            <div class="loading-overlay" :class="{visible: isWorking}">
                <span></span>
            </div>
            ...
            <section class="container-body">
                ...
                <div class="column progress-list-column">
                    ...
                    <ul class="progress-list">
                        <li class="personal complete" :class="{'current' : visibleSection == 1}" @click.prevent="goToSection(1)">
                            <span>
                                <svg>
                                    <g>
                                        <g>
                            ...
                            Personal Info</li>
                        <li class="location complete"  :class="{'current' : visibleSection == 2}" @click.prevent="goToSection(2)">
                            <span>
                                <svg>
                                    <g>
                        ...
                        <li class="details complete" :class="{'current' : visibleSection == 3}" @click.prevent="goToSection(3)">
                            <span>
                                <svg>
                                    <g>
                            ...
                            Property Details</li>
                        <li class="photos complete" :class="{'current' : visibleSection == 4}" @click.prevent="goToSection(4)">
                            <span>
                                <svg>
                                    <g>
                    ...
                    <!-- <form method="POST" action="/spots" @submit="submitForm" id="submit-property-form"> -->
                        ...
                        <div class="row form-and-null">
                            ...
                            <div class="column actual-form">
                                ...
                                <form method="POST" class="sweetspot-form" action="/spots" @submit="submitForm" id="submit-property-form" :disabled="isWorking">
                                        ...
                                        <section class="sub-section-row">
                                            ...
                                            <div class="sub-column">
                                                ...
                                                <section class="fieldset required single-field"
                                                    ...
                                                    <input type="text" id="full-name" name="owner_name" v-model="owner_name" :disabled="isWorking"
                                                ...
                                                <section class="fieldset">
                                                    ...
                                                    <section class="fieldset single-field"
                                                        ...
                                                        <input type="text" id="email-address" name="email" v-model="email" :disabled="isWorking"
                                                    ...
                                                    <section class="fieldset single-field"
                                                        ...
                                                        <input type="text" id="confirm-email" name="email_confirmation" :disabled="isWorking"
                                                ...
                                                <section class="fieldset">
                                                    ...
                                                    <section class="fieldset single-field half-width"
                                                        ...
                                                        <input type="phone" name="phone" id="phone-number" v-model="phone" :disabled="isWorking"
                                        ...
                                        <section class="sub-section-row">
                                            ...
                                            <div class="section-description sub-column">
                                                <section class="description-detail">
                                                    ...
                                                    <p>You can only change the street address and map location on an existing spot</p>
                                                </section>
                                            </div>
                                            ...
                                            <div class="sub-column">
                                                <section class="fieldset required single-field"
                                                    ...
                                                    <input type="text" id="full-name" name="address1" v-model="address1" :disabled="isWorking"
                                                        :class="{'filled': (address1.length || address1 > 0), 'ouch': errors.has('address1')}"
                                                        data-vv-scope="scope-3"
                                                        v-validate="'required|max:100'" data-vv-as="Property Address" />
                                                    <label for="full-name">Property Address</label>
                                                    <span class="errors"
                                                        v-if="errors.has('scope-3.address1')">{{ errors.first('scope-3.address1') }}</span>
                                                </section>
                                                ...
                                                <div class="icon-message visible">
                                        ...
                                        <section class="sub-section-row">
                                            ...
                                            <div class="sub-column">
                                                <section class="fieldset required single-field"
                                                    ...
                                                    <input type="text" id="property-title" name="name" v-model="name" :disabled="isWorking"
                                                ...
                                                <section class="fieldset required single-field"
                                                    ...
                                                    <input type="url" id="property-website" name="website" v-model="website" :disabled="isWorking"
                                            ...
                                            <div class="sub-column">
                                                <section class="fieldset">
                                                    ...
                                                    <section class="fieldset single-field"
                                                        ...
                                                        <input type="text" id="property-beds" name="beds" v-model="beds" :disabled="isWorking"
                                                ...
                                                <section class="fieldset">
                                                    <section class="fieldset single-field half-width"
                                                        ...
                                                        <input type="url" id="property-sleeps" name="sleeps" v-model="sleeps" :disabled="isWorking"
                                    ...
                                    <property-photos
                                        ...
                                        :init-photos="initdata.all_photos"
                                        v-on:add-photo="addPhoto"
                                        v-on:remove-photo="removePhoto"
                                    ></property-photos>
...
<script>
    ...
    export default {
        ...
        methods: {
            initSetup() {
                let fields = ['id','owner_name', 'website', 'email', 'email_confirmation', 'phone', 'name', 'desc', 'price', 'sleeps', 'baths', 'beds', 'address1', 'city', 'state', 'postal_code', 'lat', 'lng']
                var self = this;
                fields.forEach((field) => {
                    self[field] = (self.initdata[field]) ? self.initdata[field] : '';
                });

                this.selectedAmenities = this.initdata.amenities.map(a => a.id);
            ...
            sendRequest() {
                ...
                formData.edit_token = this.edit_token;

                axios.patch('/api/spots/'+this.id, formData)
                    .then(response => {
            ...
            addPhoto(payload) {
                if (payload.hasOwnProperty('isMain') && payload.isMain) {
                    this.photos.unshift(payload.id);
                } else {
                    this.photos.push(payload.id);
                }
            },
            removePhoto(id) {
                this.photos.splice(
                    this.photos.indexOf(id),
                    1
                );
            }
