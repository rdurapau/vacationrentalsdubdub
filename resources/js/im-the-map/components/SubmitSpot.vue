<template>
    <section class="modal-background" v-show="modalIsVisible">
        <section class="modal-background whoa-there" v-show="confirmationModalIsVisible">
            <div class="warning-modal">
                ...
                <ul class="warning-controls">
                    <li><a href="#" @click.prevent="cancelClose">Cancel</a></li>
                    <li><a href="#" @click.prevent="confirmClose">Yep, I'm sure.</a></li>
                </ul>
            </div>
        </section>
        ...
        <section class="modal-container">          
            ...
            <section class="container-head">
                <h1 class="logo"></h1>
                <a href="" class="close" @click.prevent="closeButtonClicked"></a>
            </section>
                ...
                <div class="modal-intro-outro">
                    <ul class="intro-outro-columns">
                        <li>
                            ...
                            <a class="btn btn-special" @click.prevent="closeButtonClicked">Awesome! Take me home.</a>
                        </li>
                    </ul>
                </div>
            </section>

            <submit-spot-form v-if="visibleScreen === 'newPropertyForm'"
                :amenities="amenities"
