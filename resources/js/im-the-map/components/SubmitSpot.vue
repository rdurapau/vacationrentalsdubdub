            ...
            <section class="container-body">
                ...
                <div class="column form-stuffs">
                                        ...
                                        <div class="sub-column">
                                            ...
                                            <section class="fieldset">
                                                ...
                                                <section class="fieldset single-field"
                                                    ...
                                                    <input type="text" id="confirm-email" name="email_confirmation"
                                            ...
                                            <section class="fieldset">
                                                ...
                                                <section class="fieldset single-field half-width"
                                                    ...
                                                    <input type="phone" name="phone" id="phone-number" v-model="phone"
                    ...
                    <div class="row action-row">
                        <button class="btn secondary" @click.prevent="backButtonClicked">Back</button>
                        <button class="btn" @click.prevent="saveAndContinue">Save & Continue</button>
                    </div>
