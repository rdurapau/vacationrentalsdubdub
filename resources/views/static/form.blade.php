          ...
          <section class="container-body">
            ...
            <div class="column form-stuffs">
                      ...
                      <fieldset class="section-wrap inactive active">
                        ...
                        <section class="sub-section-row">
                          ...
                          <div class="sub-column">
                            ...
                            <section class="fieldset required">
                              <input type="text" id="full-name" class="filled" value="Josiah Platt">
                        ...
                        <section class="sub-section-row">
                          ...
                          <div class="sub-column">
                            ...
                            <ul class="amenities">
                              <li>
                                  <input type="checkbox" name="amenity1" id="amenity1" value="Cheese">
                                  <label for="amenity1">Old Cheese</label>
                              </li>
                              <li>
                                  <input type="checkbox" name="amenity1" id="amenity2" value="Cheese">
                                  <label for="amenity2">Bikes</label>
                              </li>
                              <li>
                                  <input type="checkbox" name="amenity1" id="amenity3" value="Cheese">
                                  <label for="amenity3">Scissors</label>
                              </li>
                              <li>
                                  <input type="checkbox" name="amenity1" id="amenity4" value="Cheese">
                                  <label for="amenity4">Guns</label>
                              </li>
                              <li>
                                  <input type="checkbox" name="amenity1" id="amenity5" value="Cheese">
                        ...
                        <section class="sub-section-row">
                          ...
                          <div class="sub-column">
                            ...
                            <section class="fieldset required">
                              <textarea type="text" id="property-description"></textarea>
              ...
              <div class="row action-row">
                <button class="btn secondary" onclick="window.location.href='/static'">Back</button>
                <button class="btn" onclick="window.location.href='/static/done'">Save & Continue</button>
              </div>
