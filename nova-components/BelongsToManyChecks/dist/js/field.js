...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('index-belongs-to-many-checks', __webpack_require__(3));
    Vue.component('detail-belongs-to-many-checks', __webpack_require__(6));
    Vue.component('form-belongs-to-many-checks', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        // groupedFields() {
        //     if (this.field.hasOwnProperty('populateWith') && this.field.populateWith) {
        //         this.field.populateWith
        //     }
        // }
    }
...
var render = function() {
  ...
  return _c(
    "panel-item",
    { attrs: { field: _vm.field, fullWidthContent: true } },
    [
      _c("template", { slot: "value" }, [
        _vm.field.selected.length
          ? _c(
              "div",
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setInitialValue: function setInitialValue() {
            ...
            var col = _.chain(this.field.populateWith).groupBy('type').value();
            // .forEach(obj => {
            //     console.log(obj);
            ...
            console.log(_typeof(this.options.essentials));
        ...
        initData: function initData() {
            var self = this;
            // this.options = [];
            this.field.populateWith.forEach(function (option) {
                self.options.push({
                    value: option.id,
                    name: option.name,
                    type: option.type,
         ...
         */
        handleChange: function handleChange(selectedValues) {
    ...
    computed: {
        ...
        groupedValues: function groupedValues() {
            var col = _.chain(this.options).groupBy('type').value();
  ...
  return _c(
    ...
    [
      _c(
        "template",
        { slot: "field" },
        _vm._l(_vm.groupedValues, function(group, key) {
          return _c("div", [
            _c("h3", { staticClass: "capitalize font-semibold pt-2" }, [
              _vm._v(_vm._s(key))
            ]),
            _vm._v(" "),
            _c(
              "div",
              { staticClass: "flex flex-wrap w-full pt-3" },
              _vm._l(group, function(option) {
                return _c(
                  "span",
                  { staticClass: "w-1/4 mb-2" },
                  [
                    _c(
                      "checkbox",
                      {
                      ...
                      [
                        _c(
                          "span",
                          {
                            staticClass: "ml-1 cursor-default select-none",
                            on: {
