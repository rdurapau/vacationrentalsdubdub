...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-moderate-submission', __webpack_require__(3));
    Vue.component('detail-moderate-submission', __webpack_require__(6));
    Vue.component('form-moderate-submission', __webpack_require__(9));
});
