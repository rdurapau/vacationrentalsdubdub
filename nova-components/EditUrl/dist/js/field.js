...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-edit-url', __webpack_require__(3));
    Vue.component('detail-edit-url', __webpack_require__(6));
    Vue.component('form-edit-url', __webpack_require__(9));
});
