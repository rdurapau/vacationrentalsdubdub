...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-map-location', __webpack_require__(3));
    Vue.component('detail-map-location', __webpack_require__(6));
    Vue.component('form-map-location', __webpack_require__(9));
});
...
mapboxgl.accessToken = Object({"NODE_ENV":"development"}).MIX_MAPBOX_APP_KEY;
