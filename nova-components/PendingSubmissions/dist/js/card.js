...
Nova.booting(function (Vue, router, store) {
    Vue.component('pending-submissions', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        axios.get('/nova-vendor/pending-submissions/count').then(function (result) {
            ...
            [
              ...
              _vm.showButton
                ? _c(
                    ...
                    {
                      staticClass:
                        "bg-primary text-white text-xs font-bold py-1 px-4 rounded mx-auto mt-3",
                      attrs: {
                        exact: "",
                        tag: "button",
                        to: {
        ...
        : _c(
            ...
            [
              _c(
                "svg",
                {
                  staticClass: "text-60 mx-auto block",
